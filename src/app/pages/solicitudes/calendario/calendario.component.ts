...
import { InsertUpdateCalendarioComponent } from './insert-update-calendario/insert-update-calendario.component';
...
export class CalendarioComponent {
  ...
  constructor(
    public _service: PackageCalendarioService,
  ...
  crear() {
    ...
    this._dialog.open(InsertUpdateCalendarioComponent);
